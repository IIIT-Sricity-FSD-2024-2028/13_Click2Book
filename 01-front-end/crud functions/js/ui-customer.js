...
/* Logged-in customer — reads from session/localStorage (set on login), falls back to C001 for demo */
const CURRENT_CUSTOMER_ID = sessionStorage.getItem('c2b_loggedInId')
