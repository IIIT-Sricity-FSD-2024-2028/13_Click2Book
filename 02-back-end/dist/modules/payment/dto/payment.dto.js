...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 120, description: 'Discount applied from offer' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'UPI', description: 'UPI | Card | NetBanking | Wallet' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
