...
let SupportRequestRepository = class SupportRequestRepository {
    requests = [
        ...
        { requestId: 'SR003', customerId: 'C003', description: 'Refund not received after 7 days.', status: support_status_enum_1.SupportStatus.ESCALATED, createdDate: '2026-05-03' },
    ];
    create(data) {
