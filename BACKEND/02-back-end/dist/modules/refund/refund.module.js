...
exports.RefundModule = RefundModule = __decorate([
    (0, common_1.Module)({
        imports: [cancellation_module_1.CancellationModule, payment_module_1.PaymentModule],
        ...
        exports: [refund_service_1.RefundService, refund_repository_1.RefundRepository],
    })
], RefundModule);
