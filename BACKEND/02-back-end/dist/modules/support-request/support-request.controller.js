...
let SupportRequestController = class SupportRequestController {
    ...
    escalate(id) { return this.service.escalate(id); }
};
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPPORT, role_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Escalate a ticket to Admin (Support)' }),
    (0, swagger_1.ApiParam)({ name: 'id', example: 'SR002' }),
    (0, swagger_1.ApiHeader)({ name: 'x-role', required: true, schema: { example: 'SUPPORT' } }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SupportRequestController.prototype, "escalate", null);
