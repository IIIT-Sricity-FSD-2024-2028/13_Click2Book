...
let TripService = class TripService {
    ...
    confirm(id) {
        ...
        if (trip.tripStatus !== trip_status_enum_1.TripStatus.SCHEDULED)
            throw new common_1.BadRequestException('Only SCHEDULED trips can be confirmed');
        return (0, response_util_1.successResponse)('Trip confirmed', this.tripRepo.update(id, { tripStatus: trip_status_enum_1.TripStatus.SCHEDULED }));
    }
};
