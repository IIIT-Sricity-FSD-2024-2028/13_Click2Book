...
export class TripService {
  ...
  confirm(id: string) {
    ...
    if (trip.tripStatus !== TripStatus.SCHEDULED)
      throw new BadRequestException('Only SCHEDULED trips can be confirmed');
    return successResponse('Trip confirmed', this.tripRepo.update(id, { tripStatus: TripStatus.SCHEDULED }));
  }
}
